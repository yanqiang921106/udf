...
@Resolve({"string,string,string,string,string,string,string,string->string,string,string,string,string,string,string"})
public class cube4SixDim extends UDTF {
...
//        指标数组
        ...
        if(index.length>0){
            for(String res:combination) {
                ...
                forward(out[0],out[1],out[2],out[3],out[4],out[5],out[6]);
//                forward(out);
            }
        }else {
            for(String res:combination) {
