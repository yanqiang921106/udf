...
//@Resolve({"string,bigint,double,double,string,string,string,string,string,string,string,string,string,string,string->string,string,string,string,string,string,string,string,string,string,string,double,double"})
@Resolve({"string,bigint,string,string,string,string,string,string,string,string,string,string,string,string,string->string,string,string,string,string,string,string,string,string,string,string,double,double"})
public class cube4Itm extends UDTF {
...
//        指标数组
        ...
        if(index.length>0){
            for(String res:combination) {
                ...
                forward(out[0],out[1],out[2],out[3],out[4],out[5],out[6],out[7],out[8],out[9],out[10],Double.valueOf(out[11]),Double.valueOf(out[12]));
//                forward(out);
            }
        }else {
            for(String res:combination) {
